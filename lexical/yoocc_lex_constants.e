indexing
	description: "Constants for YOOCC expression types";
...
class YOOCC_LEX_CONSTANTS 

feature -- Access

 	Identifier: INTEGER is 1000;
	Simple_string_type: INTEGER is 1001;
	Multiplicity_integer: INTEGER is 1002;
	Special: INTEGER is 1003;
	
end -- class YOOCC_LEX_CONSTANTS
