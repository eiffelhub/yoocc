indexing
	description: "Construct Repetition_separator"
...
class REPETITION_SEPARATOR inherit

	S_REPETITION_SEPARATOR
		redefine
			construct_name,
			post_action
		end;
...
feature {CONSTRUCTS} -- semantics
	...
	post_action (level: INTEGER) is
		do
			info.working_production.set_has_separator;
			retained.post_action (level)
		end; -- post_action

end -- class REPETITION_SEPARATOR
