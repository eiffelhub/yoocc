indexing
	description: "Construct Optional_construct"
...
class OPTIONAL_CONSTRUCT inherit

	S_OPTIONAL_CONSTRUCT
		redefine
			post_action
		end;
...
feature {CONSTRUCT} -- semantics
	...
	post_action (level: INTEGER) is
		do
			from
				info.working_production.set_latest_info_optional;
				child_start
			until
				child_after
			loop
