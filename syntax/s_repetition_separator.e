indexing 
	description: "Syntax for construct Repetition_separator";
...
class S_REPETITION_SEPARATOR inherit
...
feature -- Syntax
	...
	production: LINKED_LIST [CONSTRUCT] is
			-- Production for:
			-- Repetition_separator is	
			--		Optional_repetition_separator | 
			--		Separator		
		local
			optional_repetition_separator: OPTIONAL_REPETITION_SEPARATOR; 
			separator: SEPARATOR;
		once
			!! Result.make;
			Result.forth;
			!! separator.make; put (separator); 
			!! optional_repetition_separator.make; put (optional_repetition_separator);
		end; -- production
...
end -- class S_REPETITION_MULTIPLICITY 
