indexing
	description: "Syntax for construct Production_item";
...
class S_PRODUCTION_ITEM inherit
...
feature -- Syntax
	...
	production: LINKED_LIST [CONSTRUCT] is
		...
		once
			!! Result.make;
			Result.forth;
			!! production_name.make; put (production_name);
			keyword ("::=");
			!! a_production.make; put (a_production);
			keyword (";");
		end; -- production
