indexing
	description: "Syntax for construct Optional_repetition_separator";
...
class S_OPTIONAL_REPETITION_SEPARATOR inherit
...
feature -- Syntax
	...
	production: LINKED_LIST [CONSTRUCT] is
			-- Production for:
			-- Optional_repetition_separator is	
			--	"[" Separator "]" 
		local
			separator: SEPARATOR;
		once
...
feature -- Status Report
	...
	construct_name: STRING is
		once
			Result := "Optional_repetition_separator"
		end; -- construct_name
		
end -- class S_OPTIONAL_REPETITION_SEPARATOR
