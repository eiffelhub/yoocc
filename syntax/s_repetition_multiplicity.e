indexing 
	description: "Syntax for construct Repetition_multiplicity";
...
class S_REPETITION_MULTIPLICITY inherit
...
feature -- Syntax
	...
	production: LINKED_LIST [CONSTRUCT] is
		...
		local
			repetition_cardinality: REPETITION_CARDINALITY
		once
			!! Result.make;
			Result.forth;
			keyword ("+");
			!! repetition_cardinality.make; put (repetition_cardinality);
		end; -- production
...
feature -- Status Report
	...
	construct_name: STRING is
		once
			Result := "Repetition_multiplicity"
		end; -- construct_name
