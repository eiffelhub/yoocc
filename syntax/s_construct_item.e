indexing 
	description: "Syntax for construct Construct_item"
...
class S_CONSTRUCT_ITEM inherit
...
feature -- Syntax
	...
	production: LINKED_LIST [CONSTRUCT] is
			-- Production for:
			-- Construct_item is	Optional_construct |
			--			Non_optional_construct 
		local
			optional_construct: OPTIONAL_CONSTRUCT;
			non_optional_construct: NON_OPTIONAL_CONSTRUCT;
		once
			!! Result.make;
			Result.forth;
			!! optional_construct.make; put (optional_construct);
			!! non_optional_construct.make; put (non_optional_construct);
		end; -- production
...
feature -- Status Report
	...
	construct_name: STRING is
		once
			Result := "Construct_item"
		end; -- construct_name
		
end -- class S_CONSTRUCT_ITEM
